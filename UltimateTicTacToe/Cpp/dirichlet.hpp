...
class dirichlet_distribution {
 public:
  ...
  dirichlet_distribution(const std::vector<double> &alpha);
  dirichlet_distribution(const double &alpha_value, const int &dim);
  void set_params(const std::vector<double> &alpha);
  void set_params(const double &alpha_value, const int &dim);
...
template <class RNG>
dirichlet_distribution<RNG>::dirichlet_distribution() {
  set_params(1, 1);
}
...
template <class RNG>
dirichlet_distribution<RNG>::dirichlet_distribution(const double &alpha_value,
                                                    const int &dim) {
...
template <class RNG>
void dirichlet_distribution<RNG>::set_params(
...
template <class RNG>
void dirichlet_distribution<RNG>::set_params(const double &alpha_value,
                                             const int &dim) {
  std::vector<double> alpha(dim, alpha_value);
  set_params(alpha);
}
